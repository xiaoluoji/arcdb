    ...
    public partial class CoConfigForm : Form
    {
        ...
        private void btnCoTest_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ArticleCollectOffline collectOffline = new ArticleCollectOffline(_listPath, listStartPageNum, listStopPageNum, _xpathArcurlNode, _xpathTitleNode, _xpathContentNode, subNodeParams, regexParams, _arcSubPageSymbol, arcSubPageStartNum);
